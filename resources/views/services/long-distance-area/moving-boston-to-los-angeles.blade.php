...
@section('canonical')
<link rel="canonical" href="https://www.flashmoving.net/long-distance-movers/moving-boston-to-los-angeles" />
@stop
@section('hero-title', 'Moving Boston to Los Angeles')
@section('hero-description', 'Reliable and fully licensed movers')
@section('hero-image')
<img src="/images/services/interstate/IMG_7929.jpg" alt="Movers from Boston to Los Angeles" class="hero__img hero__img--brightness-high">
@stop
...
<div id="crumbs">
    <ul vocab="https://schema.org/" typeof="BreadcrumbList">
        ...
        ›
        <li property="itemListElement" typeof="ListItem">
            <span property="name">Boston to Los Angeles Movers</span>
    ...
    <div class="content-blocks__item" >
        <div class="row content-blocks-item">
            <div class="col-lg-6 order-lg-1 content-blocks-item__preview">
                <img src="{{asset('images/services/local/content/IMG_7828.jpg')}}" alt="Movers from Boston to Los Angeles" class="content-blocks-item__img">
            </div>
