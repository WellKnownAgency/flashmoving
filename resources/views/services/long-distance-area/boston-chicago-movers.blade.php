...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How much does it cost to move to Chicago?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The Average cost for moving to Chicago is $2500. It includes labor, truck, tolls, gas and wrapping materials."
    }
  }, {
    "@type": "Question",
    "name": "How long from Boston to Chicago?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The average time for driving from Boston to Chicago is 14 hours."
    }
  }, {
    "@type": "Question",
    ...
    "@type": "Question",
    "name": "How to travel from Boston to Chicago?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can get from Boston to Chicago by plane, train, bus or car. The price can diferent depending on the day of the year, month or week."
    }
  }]
  }
</script>
...
<div id="crumbs">
    <ul vocab="https://schema.org/" typeof="BreadcrumbList">
        ...
        ›
        <li property="itemListElement" typeof="ListItem">
            <span property="name">Boston to Chicago Movers</span>
            ...
            <div class="accordion-content__list row">
                ...
                <div class="accordion-content__item col-md-6">
                    <div class="accordion-content-item">
                        ...
                        <div class="collapse accordion-content-item__body" id="collapseHourlyRate" aria-labelledby="headingHourlyRate" data-parent="#accordionPricesFaq">
                            ...
                            The Average cost for moving to Chicago is $2500. It includes labor, truck, tolls, gas and wrapping materials.<br>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-content__item col-md-6">
                    <div class="accordion-content-item">
                        ...
                        How long from Boston to Chicago?
                            <div class="accordion-content-item__button">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square"> <g transform="translate(1.000000, 1.000000)" stroke="#222222"> <path d="M0,11 L22,11"></path> <path d="M11,0 L11,22"></path> </g> </g> </svg>
                            </div>
                        </div>
                        <div class="collapse accordion-content-item__body" id="collapseLaborTime" aria-labelledby="headingLaborTime" data-parent="#accordionPricesFaq">
                            <div class="accordion-content-item__text">
                            The average time for driving from Boston to Chicago is 14 hours.<br>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-content__item col-md-6">
                    <div class="accordion-content-item">
                        ...
                        How to travel from Boston<br> to Chicago?
                            <div class="accordion-content-item__button">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square"> <g transform="translate(1.000000, 1.000000)" stroke="#222222"> <path d="M0,11 L22,11"></path> <path d="M11,0 L11,22"></path> </g> </g> </svg>
                            </div>
                        </div>
                        <div class="collapse accordion-content-item__body" id="collapseCharge" aria-labelledby="headingCharge" data-parent="#accordionPricesFaq">
                            <div class="accordion-content-item__text">
                            You can get from Boston to Chicago by plane, train, bus or car. The price can diferent depending on the day of the year, month or week.<br>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="section">
    <div class="container">
        <div class="section-header">
            <h2 class="section-title section-title--upper">Boston to Chicago moving prices</h2>
        </div>
                    ...
                    <div class="row prices-collection__row">
                        <div class="col-md-4 prices-collection__item prices-collection__item--narrow">
                            <div class="prices-collection-item">
                                ...
                                <div class="prices-collection-item__prices">
                                    <div class="prices-collection-item__price">from $3250</div>
                                </div>
                        ...
                        <div class="col-md-4 prices-collection__item prices-collection__item--wide">
                            <div class="prices-collection-item prices-collection-item--big">
                                ...
                                <div class="prices-collection-item__prices">
                                    <div class="prices-collection-item__price">from $3850</div>
                                </div>
                                <div class="prices-collection-item__features">
                                    <div class="prices-collection-item__btn-more">
                        ...
                        <div class="col-md-4 prices-collection__item prices-collection__item--narrow">
                            <div class="prices-collection-item">
                                ...
                                <div class="prices-collection-item__prices">
                                    <div class="prices-collection-item__price">from $4650</div>
                                </div>
                                <div class="prices-collection-item__features">
                                    <div class="prices-collection-item__btn-more">
