@section('title', 'Boston to Chicago Movers, Chicago to Boston Moving')
@section('dscr', 'Fully Licensed Moving Company from Boston to Chicago. Our reliable movers will make your move from Chicago to Boston simple and with no stress.')
@section('keywords', '')
@section('mainimg', '')
...
We’ll also offer a live GPS tracking with no charge and will make sure all fuel, mileage, and tolls fees are already included in the flat rate provided well in advance.
        ...
        <div class="row content-blocks-item">
            <div class="col-lg-6 order-lg-1 content-blocks-item__preview">
                <img src="{{asset('images/services/interstate/IMG_7728.jpg')}}" alt="" class="content-blocks-item__img">
            </div>
            <div class="col-lg-6 order-lg-0 content-blocks-item__body">
                <div class="content-blocks-item__body-inner">
                    <div class="content-blocks-item__text">
									...
									<div class="accordion-content-item">
											...
											<div class="collapse accordion-content-item__body" id="collapseHourlyRate" aria-labelledby="headingHourlyRate" data-parent="#accordionPricesFaq">
													<div class="accordion-content-item__text">
														Hourly rate includes professional movers, clean and fully equipped moving truck, moving blankets/pads, disassembling/reassembling of furniture, tolls, gas, mileage, taxes, and basic insurance.
														<strog>All wrapping supplies will be charged additionally based on the actual usage.</strong>
													</div>
											</div>
									</div>
							</div>
