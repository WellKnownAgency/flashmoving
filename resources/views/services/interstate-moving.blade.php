...
<link rel="canonical" href="https://www.flashmoving.net/long-distance-movers" />
@stop
...
@section('content')
    ...
    <section class="hero mb-5">
        <div class="hero__preview">
            <img src="/images/hero/IMG_7828.jpg" alt="Long Distance Moving" class="hero__img hero__img--brightness-high">
        </div>
                ...
                <div class="services-collection__list">
                    ...
                    <div style="padding-top:20px;padding-bottom:20px;font-size: 1.5em;">
                      <div class="container">
                        <div class="row">
                          <div class="col-md-3">
                            <div style="text-align:center;"><a href="/long-distance-movers/moving-boston-to-los-angeles">Los Angeles</a><br>
                            <a href="/long-distance-movers/moving-boston-to-san-frncisco">San Francisco</a><br>San Diego</div>
                          </div>
                          <div class="col-md-3">
